...
## Forked and modified by Pat York from https://github.com/ericduq/hadoop-scripts
## Suitable for Ubuntu and Debian distros
...
#	wget http://www.webhostingjams.com/mirror/apache/hadoop/common/hadoop-2.2.0/hadoop-2.2.0.tar.gz
#fi
...
## Wasn't very close to te correct answer, was it? Lets increase the number of maps and see if we can get closer
## (uncomment/run these lines one at a time
# sudo -u hduser hadoop jar ./share/hadoop/mapreduce/hadoop-mapreduce-examples-2.2.0.jar pi 4 10

# sudo -u hduser hadoop jar ./share/hadoop/mapreduce/hadoop-mapreduce-examples-2.2.0.jar pi 8 20

# sudo -u hduser hadoop jar ./share/hadoop/mapreduce/hadoop-mapreduce-examples-2.2.0.jar pi 16 40
